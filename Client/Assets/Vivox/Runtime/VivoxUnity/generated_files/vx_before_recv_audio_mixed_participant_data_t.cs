...
public class vx_before_recv_audio_mixed_participant_data_t : global::System.IDisposable {
  ...
  public string participant_display_name {
    set {
      VivoxCoreInstancePINVOKE.vx_before_recv_audio_mixed_participant_data_t_participant_display_name_set(swigCPtr, value);
    } 
    get {
      string ret = VivoxCoreInstancePINVOKE.vx_before_recv_audio_mixed_participant_data_t_participant_display_name_get(swigCPtr);
      return ret;
    } 
  }
